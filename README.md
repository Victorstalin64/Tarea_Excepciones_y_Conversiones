...
El código está organizado por paquetes correspondientes a cada actividad práctica dentro del directorio de fuentes (`src`), estructurado exactamente de la siguiente manera:
...
└── Actividad4/
    ...
    ├── Main.java
    └── MonedaNoSoportadaException.java
